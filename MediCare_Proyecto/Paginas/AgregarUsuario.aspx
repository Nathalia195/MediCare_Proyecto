<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AgregarUsuario.aspx.cs" Inherits="MediCare_Proyecto.Formulario_web14" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div>
            ...
            <asp:Label ID="LblContrasena" runat="server" Text="Contrasena"></asp:Label>  
              <asp:TextBox ID="txtlContrasena" runat="server"></asp:TextBox>
